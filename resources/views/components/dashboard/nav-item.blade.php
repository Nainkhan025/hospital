...
@php
    ...
    $baseClass  = 'flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-150 group';
    $activeClass = 'bg-blue-600 text-white shadow-sm';
    $inactiveClass = 'text-gray-400 hover:text-white hover:bg-gray-800';
...
<a href="{{ route($route) }}" class="{{ $baseClass }} {{ $active ? $activeClass : $inactiveClass }}">

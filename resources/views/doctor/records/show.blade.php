            ...
            <div class="space-y-4">
                <div class="flex justify-between items-center pb-4 border-b border-[#E4E4E7]">
                    <div>
                        ...
                        <p class="text-base font-semibold text-[#18181B]">{{ $record->patient->name }}</p>
                    </div>
                    <div class="text-right">
                        <p class="text-xs text-[#71717A]">Record Date</p>
                ...
                <div class="pt-3 border-t border-[#E4E4E7]">
                    <span class="text-xs font-semibold text-[#71717A] uppercase tracking-wider block mb-2">Attached Reports</span>
